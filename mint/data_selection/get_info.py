...
parser.add_argument(
    "--info_type",
    choices=["grads", "reps", "loss", "ifl"],
    help="The type of information",
)
parser.add_argument(
...
parser.add_argument("--max_length", type=int, default=1024, help="The maximum length")
parser.add_argument(
    "--zh",
    default=False,
    action="store_true",
...
if (
    args.info_type == "grads" or args.info_type == "ifl"
) and args.gradient_type == "adam":
